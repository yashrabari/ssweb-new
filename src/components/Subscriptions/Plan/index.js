...
export default function Plan({ plan: { id: planId, nickname: name, unit_amount, currency, color, availableFeatureCount, payment, height }, videos, storages, interval, monthly }) {
  ...
  const viewAddon = () => {
    setModal(<AddOnsModal storages={storages} videos={videos} nickname={name} subscription={price} currency={currency} color={color} availableFeatureCount={availableFeatureCount} buy={buyAddon} />)
  }
